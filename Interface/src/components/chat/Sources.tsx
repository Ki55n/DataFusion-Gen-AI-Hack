...
export default function Sources({
  ...
  return (
    <div className="container h-auto w-full shrink-0 rounded-lg border border-solid border-[#C2C2C2] bg-slate-300 p-5 lg:p-10">
      ...
      <div className="flex w-full max-w-[890px] flex-wrap content-center items-center gap-[15px]">
        {isLoading ? (
          <>
            <div className="h-20 w-[260px] max-w-sm animate-pulse rounded-md bg-gray-400" />
            <div className="h-20 w-[260px] max-w-sm animate-pulse rounded-md bg-gray-400" />
            <div className="h-20 w-[260px] max-w-sm animate-pulse rounded-md bg-gray-400" />
            <div className="h-20 w-[260px] max-w-sm animate-pulse rounded-md bg-gray-400" />
            <div className="h-20 w-[260px] max-w-sm animate-pulse rounded-md bg-gray-400" />
